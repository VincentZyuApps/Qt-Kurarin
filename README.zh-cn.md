...
# qt-kurarin 也是一个普通的 Python 包，也可以用以下方式运行：
uv run python -m qt_kurarin.main [选项]
```
...
> 💡 可以自行生成壁纸：[`docs/images/wallpaper/gen_wallpaper.py`](docs/images/wallpaper/gen_wallpaper.py)
...
> 💻 **[原始 C# 程序](https://www.nicovideo.jp/watch/sm41820938)** — Misaki  
